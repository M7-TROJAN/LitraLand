...
{
    public class LoginCommunityModel : PageModel
    {
        private readonly SignInManager<ApplicationUser> _signInManager;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly ILogger<LoginModel> _logger;
        private readonly List<string> _allowedRolesToLogin = new List<string> { AppRoles.SuperAdmin, AppRoles.CommunityAdmin, AppRoles.CommunityMember };

        public LoginCommunityModel(SignInManager<ApplicationUser> signInManager, UserManager<ApplicationUser> userManager, ILogger<LoginModel> logger)
        {
