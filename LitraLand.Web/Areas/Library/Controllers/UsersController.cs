...
{
    [Area("Library")]
    [Authorize(Roles = AppRoles.SuperAdmin + "," + AppRoles.LibraryAdmin)]
    public class UsersController : Controller
    {
        ...
        private List<string> _excludedRoles = [AppRoles.CommunityAdmin, AppRoles.CommunityMember];
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var excludedRolesList = string.Join(",", _excludedRoles.Select(role => $"'{role}'"));
            ...
            var query = $@"
                ...
                WHERE r.Name IS NULL OR r.Name NOT IN ({excludedRolesList})
            ";
        ...
        {
            var roles = await _roleManager.Roles.Where(r => r.Name != AppRoles.CommunityMember && r.Name != AppRoles.CommunityAdmin) // Exclude CommunityMember role and CommunityAdmin  role
