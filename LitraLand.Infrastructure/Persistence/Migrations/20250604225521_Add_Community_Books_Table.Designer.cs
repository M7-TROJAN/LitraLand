...
namespace LitraLand.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250604225521_Add_Community_Books_Table")]
    partial class Add_Community_Books_Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LitraLand.Domain.Entities.Community.CommunityBook", b =>
                {
                    ...
                    b.ToTable("CommunityBooks", null, t =>
                        {
                            t.HasCheckConstraint("CK_CommunityBooks_Price", "IsForSale = 0 OR (IsForSale = 1 AND Price IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("LitraLand.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("LitraLand.Domain.Entities.Governorate", "Governorate")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("LitraLand.Domain.Entities.Library.Author", b =>
                {
                    ...
                    b.HasOne("LitraLand.Domain.Entities.ApplicationUser", "LastUpdatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LitraLand.Domain.Entities.ApplicationUser", null)
                        .WithMany()
