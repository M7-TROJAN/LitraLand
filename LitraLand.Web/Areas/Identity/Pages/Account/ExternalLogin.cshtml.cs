...
namespace LitraLand.Web.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public IActionResult OnGet() => RedirectToPage("./LoginCommunity");
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (!string.IsNullOrEmpty(remoteError))
            {
                ...
                return RedirectToPage("./LoginCommunity", new { ReturnUrl = returnUrl });
            }
            ...
            {
                await _userManager.AddToRoleAsync(user, AppRoles.CommunityMember);
